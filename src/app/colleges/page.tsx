...
import { FilterState, SortOption, CollegeType, NaacGrade } from '@/lib/types';
...
function CollegesContent() {
  ...
  const { colleges, totalCount, filteredCount, isLoading, hasMore, loadMore } = useColleges(filters);
